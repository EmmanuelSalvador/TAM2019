...
public class RelogActivty extends AppCompatActivity {
    ...
    public class Relog extends View {
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            ColorFondoPintura.setColor(Color.	rgb(77, 142, 255));
        ...
        private void dibujar12 (Canvas canvas){
            ManesillaPintura.setTextSize(120);
            canvas.drawText("12",getWidth()/2-70,120,ManesillaPintura);
        }
        private void dibujar6 (Canvas canvas){
            ManesillaPintura.setTextSize(120);
            canvas.drawText("6",getWidth()/2-20,1400,ManesillaPintura);
        }
        private void dibujar3 (Canvas canvas){
            ManesillaPintura.setTextSize(120);
            canvas.drawText("3",getWidth()-90,getHeight()/2+45,ManesillaPintura);
        }
        private void dibujar9 (Canvas canvas){
            ManesillaPintura.setTextSize(120);
            canvas.drawText("9",15,getHeight()/2+45,ManesillaPintura);
        }
