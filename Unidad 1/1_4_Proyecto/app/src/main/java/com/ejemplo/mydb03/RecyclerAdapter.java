...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolderUsuarios> {
    ArrayList<Usuario> listaUsuarioss;

    Context context;

    public RecyclerAdapter(ArrayList<Usuario> listaUsuarioss, Context context) {
